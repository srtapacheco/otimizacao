...
import SelecionarTurmaPage from '../pages/SelecionarTurmaPage/SelecionarTurmaPage.vue'   // ADICIONADO
...
const routes = [
  ...
  {
    path: '/selecionar-turma',                      // ADICIONADO
    name: 'Selecionar Turma',
    component: SelecionarTurmaPage,
    meta: { requireAuth: true }
  },
  {
    path: '/calendario',
